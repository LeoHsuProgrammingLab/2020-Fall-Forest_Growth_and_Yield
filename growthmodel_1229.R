...
#test <- read.csv("C:\\Users\\KevinMarlarn\\Downloads\\JGZ1936.csv")

run_test <- CjGY(test$DBH, nrow(test), 10, 100, 0.153)

#run_test[1]
plot(run_test[[2]]$Age, run_test[[2]]$QMD)
plot(run_test[[2]]$Age, run_test[[2]]$Den)

#xx <- subset(run_test[[1]], run_test[[1]]$Age==99)
#plot(xx$Age, xx$Height)
